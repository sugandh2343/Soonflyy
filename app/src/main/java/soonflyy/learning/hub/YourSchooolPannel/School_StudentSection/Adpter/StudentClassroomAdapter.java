...
public class StudentClassroomAdapter extends RecyclerView.Adapter<StudentClassroomAdapter.ViewHolder> {
        Context context;
        ArrayList<StudentClassroomModel>list;
...
public interface OnClassClickListener {
    ...
    public StudentClassroomAdapter(Context context, ArrayList<StudentClassroomModel> list, OnClassClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        StudentClassroomModel model = list.get(position);
