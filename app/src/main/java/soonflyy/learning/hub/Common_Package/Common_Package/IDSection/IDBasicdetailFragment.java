...
//                callApi(ApiCode.GET_USER_DETAILS,params);
            ...
            case ApiCode.ADD_BASIC_DETAILS:
               // params.put("user_id",new SessionManagement(getActivity()).getString(USER_ID));
                ...
                filePathAndName = "Id/" +new SessionManagement(getActivity()).getString(ID_SECTION_USER_ID);
                ...
                storageReference.putFile(imgUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        params.put("photo",""+downloadImageUri);
                        reference.child(new SessionManagement(getActivity()).getString(ID_SECTION_USER_ID)).addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if(snapshot.exists()){
                                    progressDialog.dismiss();
                                    CommonMethods.showSuccessToast(getActivity(),"Some Error Occurred");
                                }else{
                                    reference.child(new SessionManagement(getActivity()).getString(ID_SECTION_USER_ID)).updateChildren(params).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
