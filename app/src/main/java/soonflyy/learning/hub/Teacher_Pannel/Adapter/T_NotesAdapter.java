...
public class T_NotesAdapter extends RecyclerView.Adapter<T_NotesAdapter.NoteHolder> {
    Context context;
    ArrayList<T_Notes>notList;
    OnNoteClickListener listener;
int count = -1;
    public T_NotesAdapter(Context context, ArrayList<T_Notes> notList, OnNoteClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull NoteHolder holder, int position) {
        ...
        T_Notes model=notList.get(adapterPosition);
